...
metaTitle: "What is Grey Fleet? A UK Employer's Guide | Olaris"
...
faqSchema:
  ...
  - question: "Is an employer responsible for grey fleet vehicles?"
    answer: "Yes. Under the Health and Safety at Work Act 1974, employers owe the same duty of care to employees driving their own vehicles for work as they do to employees driving company vehicles. This includes ensuring the driver is licensed, the vehicle is roadworthy and insured for business use."
  - question: "How often should employers check grey fleet driver licences?"
    answer: "At minimum annually, though best practice is quarterly. Checks should also be conducted after any reported incident or change in circumstances. DVLA licence checks require employee consent under GDPR."
  - question: "What insurance does a grey fleet driver need?"
    answer: "Grey fleet drivers need motor insurance that includes business use — typically Class 1 business use as a minimum. A standard social, domestic, and pleasure policy does not cover business journeys. Employers should verify business use cover by requesting a copy of the insurance certificate."
  - question: "How many grey fleet vehicles are there in the UK?"
    answer: "Estimates suggest there are approximately 14 million grey fleet vehicles on UK roads, compared to around 1 million company cars. Around 75% of employees who drive for work use their own vehicle."
  - question: "Can an employer be prosecuted for a grey fleet accident?"
    answer: "Yes. If a grey fleet driver is involved in a serious road incident while driving for work, and the employer failed to take reasonable steps to ensure the driver and vehicle were fit to be on the road, prosecutions can be brought under the Health and Safety at Work Act 1974, the Road Traffic Act 1988, and in fatal cases, the Corporate Manslaughter and Corporate Homicide Act 2007."
  - question: "What should a grey fleet policy include?"
...
This means [checking their driving licence through the DVLA](/features/dvla-compliance) — not just glancing at the photocard. You need to confirm the licence is valid, covers the category of vehicle they are driving, and shows no disqualifications or unspent endorsements that would affect their ability to drive safely for work.
...
This is where automated compliance checking earns its keep. [Platforms that integrate directly with DVLA records](/features/dvla-compliance) can run licence verification automatically and flag issues as they arise rather than waiting for a scheduled review. The same applies to MOT status checks and insurance document management.

Alongside licence compliance, [driver behaviour monitoring](/features/driver-behaviour) becomes relevant for grey fleet as soon as you have telematics data available. If a driver is using their own vehicle with a connected app or device, the same scoring principles apply — and the same insurance benefits follow.
